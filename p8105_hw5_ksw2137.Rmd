...
# Problem 3
In this problem, we are going the be taking our hands on some simple linear regression simulation, which has a general formula of: $$y_i=\beta_0 + \beta_1\cdot x_{i1} + \epsilon_i$$
...
We will then vary $\beta_1=\{0, 1, 2, 3, 4, 5, 6 \}$
