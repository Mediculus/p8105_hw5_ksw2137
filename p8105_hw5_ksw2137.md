...
likely because we are taking a “smaller sample” of the β̂1 values (due
to filters). As in our previous figure 2, as our effect size gets
larger, we are “capturing” more data points as well, which makes our
average a better estimate (less biased). This is analogous to taking a
larger sample size to approach normality. β̂1 at 0 is approximately
equal to the β1 is a slightly unique case as it behaves like the
“opposite” of β1 = 6. Where β1 = 6 captures “most” of the estimates,
β1 = 0 captures “almost none”, thus also closely approximating the true
β1.
